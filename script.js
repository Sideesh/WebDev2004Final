...
const deities = [
  ...
  { name: "Shiva", role: "Destroyer and transformer", symbol: "Trident, third eye", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgTZX1fZoGDurcDVARMgr2_sxmrMl53EMhXA&s" },
...
async function askAI() {
  ...
  const prompt = `Answer the following question about Hinduism in clear, respectful, plain text only. 
  Use no bold, italics, markdown, numbering, asterisks, or special formatting at all. 
  ${depth === "detailed" ? "Give a longer, detailed explanation." : "Keep it short and simple."}
  ...
  try {
    ...
    history.push({q: question, a: cleanAnswer});
    renderHistory();
  } catch (err) {
